       ...
       <div id="info" class="tab_content">
        ...
        <div class="formRow">
         ...
         <div class="formRow">
            <label>Giá cũ: </label>
            <div class="formRight">
                <input type="text" id="price" name="giacu" value="<?=@$item['giacu']?>"  title="<?=number_format(@$item['giacu'],0,',','.')?>" class="tipS" onkeypress="return OnlyNumber(event)" />
            </div>
            <div class="clear"></div>
        </div>    
 	...
 	<div class="formRow">
       ...
       <div id="content_lang_<?=$key?>" class="tab_content">        
        ...
        <div class="formRow">
            ...
            <div class="formRow">
            <label>Size chart: <img src="./images/question-button.png" alt="Chọn loại"  class="icon_que tipS" original-title="Viết nội dung chính"> </label>
